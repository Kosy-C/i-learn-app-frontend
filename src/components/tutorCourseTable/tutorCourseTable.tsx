...
interface TableProps {
    onEdit: (course: {image: string, name: string, tutor: string, price: number}) => void;
    ...
    return (
        <div>
            <table>
                ...
                <tbody>
                    {currentCourses.map((course: { id?: any; image: any; name: any; tutor: any; price: any; }) => (
                        <tr key={course.id}>
                            <td>{course.image}</td>
                            <td>{course.name}</td>
                            <td>{course.tutor}</td>
...
const Table: React.FC<TableProps> = ({ onEdit, onDelete }) => {
    ...
    return (
        <table>
            ...
            <tbody>
                {courses.map((course: { id?: any; image: any; name: any; tutor: any; price: any; }) => (
                    <tr key={course.id}>
                        <td>{course.image}</td>
                        <td>{course.name}</td>
                        <td>{course.tutor}</td>
