      ...
      <div className="cd-container">
        ...
        <div className="cd-tutor-container">
          ...
          <div className="cd-tutor-profile">
            ...
            <div className="cd-tutorImgContainer">
              
              <img
                src={course.tutor.image}
                alt="tutor"
                className="cd-tutorImage"
              />
            </div>
        ...
        <div className="cd-time-container">
          ...
          <div className="ratings-container">
            ...
            <p className="cd-ratings">Ratings</p> <hr />
            <div className="rating-body">
              
              <p className="rating-heading">Awesome Tutor</p>
              <p>
                
              One of the best tutors online. The quality of content and delivery methodology are impeccable.
              </p>
            </div>
            <hr />
            <div className="rating-body">
